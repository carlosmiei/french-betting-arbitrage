...
headers = {
    ...
    # 'cookie': 'SESSION=8427b79ead3927f2510c3e4b15c29e82; referral_values=%7B%22type%22%3A%22reflinkid%22%2C%22val%22%3A%22924212_43A6372F07884BC4A956123625AC8C87%22%2C%22additional%22%3A%7B%22name_tag%22%3A%22btag%22%2C%22ref_partner_id%22%3Anull%2C%22bw_%22%3Anull%7D%7D; is_rtl=1; reflinkid=924212_43A6372F07884BC4A956123625AC8C87; lng=en; flaglng=en; auid=XvGEBGT4hf+e/1FSAyP0Ag==; tzo=1; _glhf=1695496402; fast_coupon=true; v3fr=1; coefview=0; typeBetNames=full; ggru=181; sh.session=085f2c5d-f690-4b4e-beec-a933e3016e8c',
    "referer": "https://22bet.com/en/live/football",
...
async def get_page(competition):
    url = "https://22bet.com/LineFeed/Get1x2_VZip"
    if (
